  ...
  return (
    <section className="bg-secondary py-16 lg:pt-8 lg:pb-28">
      <div className="max-w-[1195px] mx-auto px-4">
        ...
        <div className="mt-8 flex items-start gap-10 flex-wrap justify-between">
          <div className="lg:max-w-[467px]">
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 w-max">
          ...
          <div className="lg:max-w-[467px]">
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 w-fit">
              <div className="flex flex-col gap-4">
                <div className="flex items-center gap-2">
                  <Image alt="" src={checkGreen} width={18} height={18} />
