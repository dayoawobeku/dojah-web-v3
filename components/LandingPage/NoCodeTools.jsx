...
import {homepageNocode, homepageNocodeSm} from '../../assets/images/images';
import Hyperlink from '../Hyperlink';

export default function NoCodeTools() {
  return (
    <section className="relative">
      <div className="flex flex-col-reverse lg:flex-row items-start lg:items-center justify-start lg:justify-end gap-20 flex-wrap lg:flex-nowrap mx-auto pt-16 lg:pt-[216px] lg:pb-[131px] pl-4 pr-4 lg:pl-0 max-w-[1195px] ml-auto">
        <div className="hidden lg:block absolute lg:w-[486px] lg:h-[469.5px] xl:w-[586px] xl:h-[566px] left-0 bottom-0">
